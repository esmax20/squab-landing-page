...
const FlagArg = () => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink'
            ...
            <g id='c'>
                <path id='a' fill='#f6b40e' stroke='#85340a' stroke-width='1.112'
                ...
                <use xlinkXhref='#a' transform='rotate(22.5 400 250)' />
                <use xlinkXhref='#a' transform='rotate(45 400 250)' />
                <use xlinkXhref='#a' transform='rotate(67.5 400 250)' />
                ...
                <use xlinkXhref='#b' transform='rotate(22.5 400 250)' />
                <use xlinkXhref='#b' transform='rotate(45 400 250)' />
                <use xlinkXhref='#b' transform='rotate(67.5 400 250)' />
            </g>
            <use xlinkXhref='#c' transform='rotate(90 400 250)' />
            <use xlinkXhref='#c' transform='rotate(180 400 250)' />
            <use xlinkXhref='#c' transform='rotate(270 400 250)' />
            ...
            <use xlinkXhref='#d' transform='matrix(-1 0 0 1 800.25 0)' />
            <use xlinkXhref='#e' transform='matrix(-1 0 0 1 800.25 0)' />
            <use xlinkXhref='#f' transform='translate(18.862)' />
            <use xlinkXhref='#g' transform='matrix(-1 0 0 1 800.25 0)' />
            <path fill='#85340a'
            ...
            <use xlinkXhref='#h' transform='translate(-19.181)' />
